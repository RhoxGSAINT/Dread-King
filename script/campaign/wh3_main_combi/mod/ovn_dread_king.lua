local function spawn_new_force()
	cm:create_force_with_general(
		...
		"wh3_main_combi_region_pools_of_despair", -- region_key,
		521, -- x,
		299, -- y,
		"general", -- type,
		"Dread_King", -- subtype,
...
local function new_game_startup()
	...
	cm:override_building_chain_display("wh2_dlc09_tmb_settlement_minor", "ovn_dkl_special_settlement_pools_of_despair", "wh3_main_combi_region_pools_of_despair")

    local pools_of_despair = cm:get_region("wh3_main_combi_region_pools_of_despair")
    cm:transfer_region_to_faction("wh3_main_combi_region_pools_of_despair", "ovn_tmb_dread_king")
	cm:instantly_set_settlement_primary_slot_level(pools_of_despair:settlement(), 3)
	cm:heal_garrison(pools_of_despair:cqi());
    ...
    if wizard_agent then
        cm:force_add_trait(cm:char_lookup_str(wizard_agent), "ovn_trait_name_dummy_gunther", false)
            ...
            cm:create_force_with_general(
                    ...
                    "wh2_dlc09_tmb_inf_nehekhara_warriors_0,wh2_dlc09_tmb_inf_skeleton_archers_0,wh2_dlc09_tmb_inf_skeleton_archers_0,wh2_dlc09_tmb_inf_skeleton_warriors_0,wh2_dlc09_tmb_inf_skeleton_warriors_0,wh2_dlc09_tmb_cav_skeleton_horsemen_0",
            ...
            cm:force_declare_war("wh2_dlc09_tmb_rakaph_dynasty", "ovn_tmb_dread_king", false, false)
            
                if common.vfs_exists("script/campaign/wh3_main_combi/mod/ovn_grudgebringers.lua") then
